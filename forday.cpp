...
Создать структуру данных для работы с изображением
...
int setPointImage(Image* img,int x, int y,int color);

5. Отображения изображения на экран в pnm формате
...
Написать тесты на на функции createImage, showImage, setPointImage, setPointImage и saveToPnmFile
